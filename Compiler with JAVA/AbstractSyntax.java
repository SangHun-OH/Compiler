...
class Format {
	...
	public static void saveTextFile(String contents, String file) throws IOException {
...
class Program {
	...
	/*
	 * pass an int value to display() and have the int value represent the number of
	 * constant whitespace representation : \n : as a block that can be incremented.
	 */
...
abstract class Value extends Expression {
	...
	/*
	 * public void display() { System.out.println("Display Value Object"); }
	 */
}
...
class Operator {
	...
	final static String boolMap[][] = { { EQ, BOOL_EQ }, { NE, BOOL_NE }, { LT, BOOL_LT }, { LE, BOOL_LE },
			{ GT, BOOL_GT }, { GE, BOOL_GE }, { AND, AND }, { OR, OR }, { NOT, NOT } };
